            ...
            <div class="login-container column right">
                ...
                <form method="post" class="login-form">
                    <h2 class="login-title">Login</h2>
                        ...
                        <input type="text" name="txt_uname_email" placeholder="Username or Email" tabindex="1" required />
                        <label for="password">Password <a class="forgot-pwd" href="forgot-password.php"> Forgot your password?</a></label>
                        
                    <div class="input-icons">
                        <input id="password" type="password" name="txt_password" placeholder="Password" tabindex="2" required />
